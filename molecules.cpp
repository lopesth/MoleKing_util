...
class PeriodicTable{
    ...
    PeriodicTable(){
        ...
        massMap.insert(pair<string, float>("Li", 6.941));
        massMap.insert(pair<string, float>("Be", 9.0122));
        massMap.insert(pair<string, float>("B", 10.811));
        massMap.insert(pair<string, float>("C", 12.011));
        massMap.insert(pair<string, float>("N", 14.007));
        massMap.insert(pair<string, float>("O", 15.999));
        massMap.insert(pair<string, float>("F", 18.998));
        massMap.insert(pair<string, float>("Ne", 20.180));
        massMap.insert(pair<string, float>("Na", 22.990));
        massMap.insert(pair<string, float>("Mg", 24.305));
        massMap.insert(pair<string, float>("Al", 26.982));
        massMap.insert(pair<string, float>("Si", 28.086));
        massMap.insert(pair<string, float>("P", 30.974));
        massMap.insert(pair<string, float>("S", 32.065));
        massMap.insert(pair<string, float>("Cl", 35.453));
        massMap.insert(pair<string, float>("Ar", 39.948));
        massMap.insert(pair<string, float>("K", 39.098));
        massMap.insert(pair<string, float>("Ca", 40.078));
        massMap.insert(pair<string, float>("Sc", 44.956));
        massMap.insert(pair<string, float>("Ti", 47.867));
        massMap.insert(pair<string, float>("V", 50.942));
        massMap.insert(pair<string, float>("Cr", 51.996));
        massMap.insert(pair<string, float>("Mn", 54.938));
        massMap.insert(pair<string, float>("Fe", 55.845));
        massMap.insert(pair<string, float>("Co", 58.933));
        massMap.insert(pair<string, float>("Ni", 58.693));
        massMap.insert(pair<string, float>("Cu", 63.546));
        massMap.insert(pair<string, float>("Zn", 65.409));
        massMap.insert(pair<string, float>("Ga", 69.723));
        massMap.insert(pair<string, float>("Ge", 72.640));
        massMap.insert(pair<string, float>("As", 74.922));
        massMap.insert(pair<string, float>("Se", 78.960));
        massMap.insert(pair<string, float>("Br", 79.904));
        massMap.insert(pair<string, float>("Kr", 83.798));
        massMap.insert(pair<string, float>("Rb", 85.468));
        massMap.insert(pair<string, float>("Sr", 87.620));
        massMap.insert(pair<string, float>("Y", 88.906));
        massMap.insert(pair<string, float>("Zr", 91.224));
        massMap.insert(pair<string, float>("Nb", 92.906));
        massMap.insert(pair<string, float>("Mo", 95.940));
        massMap.insert(pair<string, float>("Tc", 98.000));
        massMap.insert(pair<string, float>("Ru", 101.07));
        massMap.insert(pair<string, float>("Rh", 102.91));
        massMap.insert(pair<string, float>("Pd", 106.42));
        massMap.insert(pair<string, float>("Ag", 107.87));
        massMap.insert(pair<string, float>("Cd", 112.41));
        massMap.insert(pair<string, float>("In", 114.82));
        massMap.insert(pair<string, float>("Sn", 118.71));
        massMap.insert(pair<string, float>("Sb", 121.76));
        massMap.insert(pair<string, float>("Te", 127.6));
        massMap.insert(pair<string, float>("I", 126.9));
        massMap.insert(pair<string, float>("Xe", 131.29));
        massMap.insert(pair<string, float>("Cs", 132.91));
        massMap.insert(pair<string, float>("Ba", 137.33));
        massMap.insert(pair<string, float>("La", 138.91));
        massMap.insert(pair<string, float>("Ce", 140.12));
        massMap.insert(pair<string, float>("Pr", 140.91));
        massMap.insert(pair<string, float>("Nd", 144.24));
        massMap.insert(pair<string, float>("Pm", 145.00));
        massMap.insert(pair<string, float>("Sm", 150.36));
        massMap.insert(pair<string, float>("Eu", 151.96));
        massMap.insert(pair<string, float>("Gd", 157.25));
        massMap.insert(pair<string, float>("Tb", 158.93));
        massMap.insert(pair<string, float>("Dy", 162.5));
        massMap.insert(pair<string, float>("Ho", 164.93));
        massMap.insert(pair<string, float>("Er", 167.26));
        massMap.insert(pair<string, float>("Tm", 168.93));
        massMap.insert(pair<string, float>("Yb", 173.04));
        massMap.insert(pair<string, float>("Lu", 174.97));
        massMap.insert(pair<string, float>("Hf", 178.49));
        massMap.insert(pair<string, float>("Ta", 180.95));
        massMap.insert(pair<string, float>("W", 183.84));
        massMap.insert(pair<string, float>("Re", 186.21));
        massMap.insert(pair<string, float>("Os", 190.23));
        massMap.insert(pair<string, float>("Ir", 192.22));
        massMap.insert(pair<string, float>("Pt", 195.08));
        massMap.insert(pair<string, float>("Au", 196.97));
        massMap.insert(pair<string, float>("Hg", 200.59));
        massMap.insert(pair<string, float>("Tl", 204.38));
        massMap.insert(pair<string, float>("Pb", 207.20));
        massMap.insert(pair<string, float>("Bi", 208.98));
        massMap.insert(pair<string, float>("Po", 209.00));
        massMap.insert(pair<string, float>("At", 210.00));
        massMap.insert(pair<string, float>("Rn", 222.00));
        massMap.insert(pair<string, float>("Fr", 223.00));
        massMap.insert(pair<string, float>("Ra", 226.00));
        massMap.insert(pair<string, float>("Ac", 227.00));
        massMap.insert(pair<string, float>("Th", 232.04));
        massMap.insert(pair<string, float>("Pa", 231.04));
        massMap.insert(pair<string, float>("U",  238.03));
        massMap.insert(pair<string, float>("Np", 237.00));
        massMap.insert(pair<string, float>("Pu", 244.00));
        massMap.insert(pair<string, float>("Am", 243.00));
        massMap.insert(pair<string, float>("Cm", 247.00));
        massMap.insert(pair<string, float>("Bk", 247.00));
        massMap.insert(pair<string, float>("Cf", 251.00));
        massMap.insert(pair<string, float>("Es", 252.00));
        massMap.insert(pair<string, float>("Fm", 257.00));
        massMap.insert(pair<string, float>("Md", 258.00));
        massMap.insert(pair<string, float>("No", 259.00));
        massMap.insert(pair<string, float>("Lr", 262.00));
        massMap.insert(pair<string, float>("Rf", 263.00));
        massMap.insert(pair<string, float>("Db", 268.00));
        massMap.insert(pair<string, float>("Sg", 271.00));
        massMap.insert(pair<string, float>("Bh", 270.00));
        massMap.insert(pair<string, float>("Hs", 270.00));
        massMap.insert(pair<string, float>("Mt", 278.00));
        massMap.insert(pair<string, float>("Ds", 281.00));
        massMap.insert(pair<string, float>("Rg", 281.00));
        massMap.insert(pair<string, float>("Cn", 265.00));
        massMap.insert(pair<string, float>("Uut", 286.00));
        massMap.insert(pair<string, float>("Fl", 289.00));
        massMap.insert(pair<string, float>("Uup", 289.00));
        massMap.insert(pair<string, float>("Lv", 293.00));
        massMap.insert(pair<string, float>("Uus", 294.00));
        massMap.insert(pair<string, float>("Uuo", 294.00));
        massMap.insert(pair<string, float>("Uue", 315.00));
        massMap.insert(pair<string, float>("Ubn", 320.00));
        massMap.insert(pair<string, float>("00", 0.0000));
        massMap.insert(pair<string, float>("dice_ghost_label", 0.0000));
