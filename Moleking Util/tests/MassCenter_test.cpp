...
unsigned int g_m4 = 8;
unsigned int g_m5 = 9;
unsigned int g_m6 = 10;
unsigned int g_m7 = 11;
unsigned int g_m8 = 14;
unsigned int g_m9 = 22;
unsigned int g_m10 = 40;
...
TEST_CASE("Mass Center Constructors"){
    ...
    vector <unsigned int> mass = {g_m1, g_m2, g_m3};
...
TEST_CASE("Mass Center Calc"){
    MassCenter massCenter1 = MassCenter(vector <unsigned int> {g_m1, g_m2, g_m3}, vector<CartesianCoordinate> {g_xyz1, g_xyz2, g_xyz3});
    MassCenter massCenter2 = MassCenter(vector <unsigned int> {g_m1, g_m2, g_m3, g_m4, g_m5}, vector<CartesianCoordinate> {g_xyz1, g_xyz2, g_xyz3, g_xyz4, g_xyz5});
    MassCenter massCenter3 = MassCenter(vector <unsigned int> {g_m1, g_m2, g_m3, g_m4, g_m5, g_m6, g_m7}, vector<CartesianCoordinate> {g_xyz1, g_xyz2, g_xyz3, g_xyz4, g_xyz5, g_xyz6, g_xyz7});
    MassCenter massCenter4 = MassCenter(vector <unsigned int> {g_m1, g_m2, g_m3, g_m4, g_m5, g_m6, g_m7, g_m8}, vector<CartesianCoordinate> {g_xyz1, g_xyz2, g_xyz3, g_xyz4, g_xyz5, g_xyz6, g_xyz7, g_xyz8});
    MassCenter massCenter5 = MassCenter(vector <unsigned int> {g_m1, g_m2, g_m3, g_m4, g_m5, g_m6, g_m7, g_m8, g_m9, g_m10}, vector<CartesianCoordinate> {g_xyz1, g_xyz2, g_xyz3, g_xyz4, g_xyz5, g_xyz6, g_xyz7, g_xyz8, g_xyz9, g_xyz10});
